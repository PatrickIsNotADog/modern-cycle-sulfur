  ...
  subroutine computeReverseRates(inTgas)
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,55) = krate(i,1)*exp(-2.775076d-1*(lnTgas(i)-1d0) &
            + 1.258706d-3*Tgas(i) &
            - 4.510004d-7*Tgas2(i) &
      ...
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,55) = krate(i,1)*exp(5.450499d-1*(lnTgas(i)-1d0) &
            - 3.939921d-4*Tgas(i) &
            + 5.516733d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,56) = krate(i,2)*exp(-2.257872d0*(lnTgas(i)-1d0) &
            + 8.400735d-3*Tgas(i) &
            - 5.554705d-6*Tgas2(i) &
            + 2.47746d-9*Tgas3(i) &
            ...
            + 5.859493d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,56) = krate(i,2)*exp(9.007697d-1*(lnTgas(i)-1d0) &
            + 1.738856d-4*Tgas(i) &
            - 5.041413d-8*Tgas2(i) &
            + 5.80007d-12*Tgas3(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,57) = krate(i,3)*exp(7.076339d-1*(lnTgas(i)-1d0) &
            - 2.334753d-3*Tgas(i) &
            + 2.330059d-6*Tgas2(i) &
            - 1.405889d-9*Tgas3(i) &
            ...
            - 3.82013d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,57) = krate(i,3)*exp(3.814896d-1*(lnTgas(i)-1d0) &
            - 2.809352d-4*Tgas(i) &
            + 3.560127d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,58) = krate(i,4)*exp(-2.009268d0*(lnTgas(i)-1d0) &
            + 1.01334d-2*Tgas(i) &
            - 8.049007d-6*Tgas2(i) &
            + 4.063298d-9*Tgas3(i) &
            ...
            + 3.121036d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,58) = krate(i,4)*exp(7.541485d-1*(lnTgas(i)-1d0) &
            + 2.786439d-4*Tgas(i) &
            - 7.387907d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,59) = krate(i,5)*exp(1.251329d0*(lnTgas(i)-1d0) &
            - 3.540927d-3*Tgas(i) &
            + 2.891923d-6*Tgas2(i) &
            - 1.485442d-9*Tgas3(i) &
            ...
            - 5.708806d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,59) = krate(i,5)*exp(2.387615d-1*(lnTgas(i)-1d0) &
            + 3.625165d-5*Tgas(i) &
            - 2.598555d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,60) = krate(i,6)*exp(-1.116324d0*(lnTgas(i)-1d0) &
            + 5.227182d-3*Tgas(i) &
            - 3.189675d-6*Tgas2(i) &
            + 1.369383d-9*Tgas3(i) &
            ...
            + 7.274798d-1)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,60) = krate(i,6)*exp(1.611705d0*(lnTgas(i)-1d0) &
            - 2.875669d-4*Tgas(i) &
            + 1.105846d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
    !  if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
    !    krate(i,61) = krate(i,7)*exp(8.837417d-1*(lnTgas(i)-1d0) &
    !        + 6.639121d-3*Tgas(i) &
    !        - 1.182399d-5*Tgas2(i) &
    !        + 6.691894d-9*Tgas3(i) &
    ...
    !  elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
    !    krate(i,61) = krate(i,7)*exp(2.321241d0*(lnTgas(i)-1d0) &
    !        - 6.394723d-3*Tgas(i) &
    !        + 7.538362d-7*Tgas2(i) &
    !        - 5.96604d-11*Tgas3(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,62) = krate(i,8)*exp(3.553689d0*(lnTgas(i)-1d0) &
            - 1.350409d-2*Tgas(i) &
            + 1.429369d-5*Tgas2(i) &
            - 7.152137d-9*Tgas3(i) &
            ...
            - 1.808164d1)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,62) = krate(i,8)*exp(-1.642933d0*(lnTgas(i)-1d0) &
            + 5.788839d-3*Tgas(i) &
            - 6.630917d-7*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,63) = krate(i,9)*exp(2.573447d0*(lnTgas(i)-1d0) &
            - 9.982074d-3*Tgas(i) &
            + 7.16588d-6*Tgas2(i) &
            - 3.355992d-9*Tgas3(i) &
            ...
            - 7.526717d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,63) = krate(i,9)*exp(-4.876406d-1*(lnTgas(i)-1d0) &
            - 3.447248d-4*Tgas(i) &
            + 6.608958d-8*Tgas2(i) &
            - 7.10943d-12*Tgas3(i) &
            + 3.52615d-16*Tgas4(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,64) = krate(i,10)*exp(1.584184d0*(lnTgas(i)-1d0) &
            - 7.598104d-3*Tgas(i) &
            + 7.298724d-6*Tgas2(i) &
            - 4.114045d-9*Tgas3(i) &
            ...
            - 4.507659d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,64) = krate(i,10)*exp(7.064366d0*(lnTgas(i)-1d0) &
            - 6.980988d-3*Tgas(i) &
            + 1.443677d-6*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,65) = krate(i,11)*exp(1.002725d0*(lnTgas(i)-1d0) &
            - 5.273593d-3*Tgas(i) &
            + 5.386224d-6*Tgas2(i) &
            - 3.07128d-9*Tgas3(i) &
            ...
            - 2.970349d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,65) = krate(i,11)*exp(3.853828d-1*(lnTgas(i)-1d0) &
            - 6.850666d-5*Tgas(i) &
            - 2.520613d-9*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,66) = krate(i,12)*exp(2.289248d-1*(lnTgas(i)-1d0) &
            - 2.744914d-3*Tgas(i) &
            + 3.195679d-6*Tgas2(i) &
            - 1.867226d-9*Tgas3(i) &
            ...
            + 2.589349d-1)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,66) = krate(i,12)*exp(1.087555d-1*(lnTgas(i)-1d0) &
            + 2.368912d-4*Tgas(i) &
            - 5.712312d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,67) = krate(i,13)*exp(-3.881414d-1*(lnTgas(i)-1d0) &
            - 3.001707d-3*Tgas(i) &
            + 3.8507d-6*Tgas2(i) &
            - 2.188698d-9*Tgas3(i) &
            ...
            + 1.669856d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,67) = krate(i,13)*exp(-3.476293d-1*(lnTgas(i)-1d0) &
            + 6.02411d-4*Tgas(i) &
            - 8.878291d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,68) = krate(i,14)*exp(5.912447d-1*(lnTgas(i)-1d0) &
            - 6.552842d-3*Tgas(i) &
            + 6.759321d-6*Tgas2(i) &
            - 3.681057d-9*Tgas3(i) &
            + 8.29721d-13*Tgas4(i) &
            ...
            - 1.615769d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,68) = krate(i,14)*exp(-4.856017d-1*(lnTgas(i)-1d0) &
            + 7.564716d-4*Tgas(i) &
            - 1.126842d-7*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,69) = krate(i,15)*exp(8.775649d-2*(lnTgas(i)-1d0) &
            - 4.496811d-4*Tgas(i) &
            + 3.892062d-7*Tgas2(i) &
      ...
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.5d3) then
        krate(i,69) = krate(i,15)*exp(1.268016d-1*(lnTgas(i)-1d0) &
            - 1.406198d-5*Tgas(i) &
            + 2.514851d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,70) = krate(i,16)*exp(7.343407d-1*(lnTgas(i)-1d0) &
            + 1.144254d-3*Tgas(i) &
            - 2.977785d-6*Tgas2(i) &
            + 2.086034d-9*Tgas3(i) &
            ...
            - 1.848608d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,70) = krate(i,16)*exp(-8.93775d-1*(lnTgas(i)-1d0) &
            + 4.267197d-4*Tgas(i) &
            - 6.956424d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,71) = krate(i,17)*exp(-1.434543d-1*(lnTgas(i)-1d0) &
            + 2.486079d-3*Tgas(i) &
            - 3.213186d-6*Tgas2(i) &
            + 2.113195d-9*Tgas3(i) &
            ...
            - 5.855506d-1)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,71) = krate(i,17)*exp(-1.149817d-1*(lnTgas(i)-1d0) &
            + 2.148543d-4*Tgas(i) &
            - 4.339076d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,72) = krate(i,18)*exp(-8.260563d-1*(lnTgas(i)-1d0) &
            + 5.994522d-3*Tgas(i) &
            - 4.896531d-6*Tgas2(i) &
            + 2.362869d-9*Tgas3(i) &
            ...
            + 7.549152d-1)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,72) = krate(i,18)*exp(7.35362d0*(lnTgas(i)-1d0) &
            - 6.932257d-3*Tgas(i) &
            + 1.445745d-6*Tgas2(i) &
            - 1.57388d-10*Tgas3(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,73) = krate(i,19)*exp(-4.312865d-1*(lnTgas(i)-1d0) &
            + 2.22883d-4*Tgas(i) &
            + 1.19644d-6*Tgas2(i) &
            - 1.100242d-9*Tgas3(i) &
            ...
            + 3.021177d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,73) = krate(i,19)*exp(7.254038d0*(lnTgas(i)-1d0) &
            - 6.945426d-3*Tgas(i) &
            + 1.461383d-6*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,74) = krate(i,20)*exp(5.579769d-1*(lnTgas(i)-1d0) &
            - 2.161087d-3*Tgas(i) &
            + 1.063596d-6*Tgas2(i) &
            ...
            + 2.11912d-3)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,74) = krate(i,20)*exp(-2.979689d-1*(lnTgas(i)-1d0) &
            - 3.091634d-4*Tgas(i) &
            + 8.379577d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,75) = krate(i,21)*exp(1.435772d0*(lnTgas(i)-1d0) &
            - 3.502913d-3*Tgas(i) &
            + 1.298996d-6*Tgas2(i) &
            ...
            - 1.260939d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,75) = krate(i,21)*exp(-1.076762d0*(lnTgas(i)-1d0) &
            - 9.729794d-5*Tgas(i) &
            + 5.762229d-8*Tgas2(i) &
            - 6.67916d-12*Tgas3(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,76) = krate(i,22)*exp(-3.307801d-1*(lnTgas(i)-1d0) &
            - 7.751533d-4*Tgas(i) &
            + 1.465141d-6*Tgas2(i) &
            ...
            + 2.427759d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,76) = krate(i,22)*exp(2.087491d-1*(lnTgas(i)-1d0) &
            - 1.603123d-4*Tgas(i) &
            + 4.013125d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,77) = krate(i,23)*exp(-6.871497d-1*(lnTgas(i)-1d0) &
            + 3.692253d-3*Tgas(i) &
            - 3.775049d-6*Tgas2(i) &
            + 2.192748d-9*Tgas3(i) &
            ...
            + 1.303125d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,77) = krate(i,23)*exp(2.774641d-2*(lnTgas(i)-1d0) &
            - 1.023326d-4*Tgas(i) &
            + 1.819606d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,78) = krate(i,24)*exp(-1.676413d0*(lnTgas(i)-1d0) &
            + 6.076223d-3*Tgas(i) &
            - 3.642205d-6*Tgas2(i) &
            + 1.434695d-9*Tgas3(i) &
            ...
            + 4.322183d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,78) = krate(i,24)*exp(7.579753d0*(lnTgas(i)-1d0) &
            - 6.738596d-3*Tgas(i) &
            + 1.395783d-6*Tgas2(i) &
            - 1.51943d-10*Tgas3(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,79) = krate(i,25)*exp(1.906453d-1*(lnTgas(i)-1d0) &
            + 2.350427d-3*Tgas(i) &
            - 3.539649d-6*Tgas2(i) &
            + 2.165587d-9*Tgas3(i) &
            ...
            + 4.006756d-2)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,79) = krate(i,25)*exp(-7.510469d-1*(lnTgas(i)-1d0) &
            + 1.095328d-4*Tgas(i) &
            - 7.977419d-9*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,80) = krate(i,26)*exp(1.61001d0*(lnTgas(i)-1d0) &
            - 8.009682d-3*Tgas(i) &
            + 6.273806d-6*Tgas2(i) &
            - 3.072642d-9*Tgas3(i) &
            ...
            - 1.31498d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.5d3) then
        krate(i,80) = krate(i,26)*exp(-5.787838d-1*(lnTgas(i)-1d0) &
            - 1.413477d-4*Tgas(i) &
            + 6.323959d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,81) = krate(i,27)*exp(9.251222d-1*(lnTgas(i)-1d0) &
            - 4.310392d-3*Tgas(i) &
            + 4.183748d-6*Tgas2(i) &
            - 2.427028d-9*Tgas3(i) &
            ...
            - 5.108402d-1)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,81) = krate(i,27)*exp(6.75679d0*(lnTgas(i)-1d0) &
            - 6.822651d-3*Tgas(i) &
            + 1.426713d-6*Tgas2(i) &
            - 1.55403d-10*Tgas3(i) &
            + 6.59569d-15*Tgas4(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,82) = krate(i,28)*exp(2.513155d-1*(lnTgas(i)-1d0) &
            - 3.28556d-3*Tgas(i) &
            + 2.879785d-6*Tgas2(i) &
            - 1.349916d-9*Tgas3(i) &
            ...
            + 1.680711d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,82) = krate(i,28)*exp(-2.145633d-1*(lnTgas(i)-1d0) &
            + 2.016848d-4*Tgas(i) &
            - 2.77529d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,83) = krate(i,29)*exp(-3.706548d0*(lnTgas(i)-1d0) &
            + 5.543697d-4*Tgas(i) &
            + 4.589081d-6*Tgas2(i) &
            - 3.664404d-9*Tgas3(i) &
      ...
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,83) = krate(i,29)*exp(6.324081d0*(lnTgas(i)-1d0) &
            - 5.98477d-3*Tgas(i) &
            + 1.287301d-6*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,84) = krate(i,30)*exp(-4.568213d-1*(lnTgas(i)-1d0) &
            + 4.389574d-3*Tgas(i) &
            - 3.938993d-6*Tgas2(i) &
            + 2.014456d-9*Tgas3(i) &
            - 4.35746d-13*Tgas4(i) &
            ...
            + 2.080435d0)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.5d3) then
        krate(i,84) = krate(i,30)*exp(5.001109d-1*(lnTgas(i)-1d0) &
            - 1.699002d-4*Tgas(i) &
            - 6.723714d-9*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,85) = krate(i,31)*exp(2.907618d-1*(lnTgas(i)-1d0) &
            + 2.512911d-3*Tgas(i) &
            - 2.879387d-6*Tgas2(i) &
            + 1.644321d-9*Tgas3(i) &
            ...
            - 1.13614d-1)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.5d3) then
        krate(i,85) = krate(i,31)*exp(3.861018d-1*(lnTgas(i)-1d0) &
            - 9.114733d-5*Tgas(i) &
            - 1.33545d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,86) = krate(i,32)*exp(4.468463d0*(lnTgas(i)-1d0) &
            - 8.475314d-3*Tgas(i) &
            + 4.624041d-6*Tgas2(i) &
            - 1.883545d-9*Tgas3(i) &
      ...
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,86) = krate(i,32)*exp(6.310961d-1*(lnTgas(i)-1d0) &
            - 5.418875d-4*Tgas(i) &
            + 7.125405d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,87) = krate(i,33)*exp(4.482077d0*(lnTgas(i)-1d0) &
            - 9.672905d-3*Tgas(i) &
            + 5.280526d-6*Tgas2(i) &
            - 2.124199d-9*Tgas3(i) &
      ...
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,87) = krate(i,33)*exp(2.856084d-2*(lnTgas(i)-1d0) &
            - 4.957808d-4*Tgas(i) &
            + 7.049484d-8*Tgas2(i) &
            - 5.55515d-12*Tgas3(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,88) = krate(i,34)*exp(2.039365d0*(lnTgas(i)-1d0) &
            - 8.55842d-3*Tgas(i) &
            + 5.821711d-6*Tgas2(i) &
            - 2.687074d-9*Tgas3(i) &
      ...
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,88) = krate(i,34)*exp(-1.361725d0*(lnTgas(i)-1d0) &
            + 5.032744d-5*Tgas(i) &
            + 1.803258d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
    !  if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
    !    krate(i,89) = krate(i,35)*exp(-7.124894d0*(lnTgas(i)-1d0) &
    !        + 1.677694d-2*Tgas(i) &
    !        - 9.790732d-6*Tgas2(i) &
    !        + 4.249147d-9*Tgas3(i) &
    !        - 8.65185d-13*Tgas4(i) &
    ...
    !  elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
    !    krate(i,89) = krate(i,35)*exp(2.742437d-1*(lnTgas(i)-1d0) &
    !        + 8.570799d-4*Tgas(i) &
    !        - 1.209464d-7*Tgas2(i) &
    ...
    do i=1,cellsNumber
    !  if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
    !    krate(i,90) = krate(i,36)*exp(3.543341d0*(lnTgas(i)-1d0) &
    !        - 4.164922d-3*Tgas(i) &
    !        + 4.402935d-7*Tgas2(i) &
    ...
    !  elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
    !    krate(i,90) = krate(i,36)*exp(-6.125694d0*(lnTgas(i)-1d0) &
    !        + 6.280764d-3*Tgas(i) &
    !        - 1.355459d-6*Tgas2(i) &
    !        + 1.4979d-10*Tgas3(i) &
    ...
    do i=1,cellsNumber
    !  if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
    !    krate(i,91) = krate(i,37)*exp(-1.468995d0*(lnTgas(i)-1d0) &
    !        - 6.183049d-5*Tgas(i) &
    !        - 8.383324d-8*Tgas2(i) &
    ...
    !  elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
    !    krate(i,91) = krate(i,37)*exp(-1.879309d0*(lnTgas(i)-1d0) &
    !        + 5.235596d-4*Tgas(i) &
    !        - 4.24307d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
    !  if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
    !    krate(i,92) = krate(i,38)*exp(2.67174d0*(lnTgas(i)-1d0) &
    !        - 1.667105d-2*Tgas(i) &
    !        + 9.453086d-6*Tgas2(i) &
    !        - 3.840731d-9*Tgas3(i) &
    ...
    !        - 1.111545d1)
    !  elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
    !    krate(i,92) = krate(i,38)*exp(-4.700143d0*(lnTgas(i)-1d0) &
    !        - 6.490479d-4*Tgas(i) &
    !        + 8.865994d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,93) = krate(i,39)*exp(4.774011d0*(lnTgas(i)-1d0) &
            - 1.557652d-3*Tgas(i) &
            + 7.154449d-6*Tgas2(i) &
            - 4.178225d-9*Tgas3(i) &
      ...
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,93) = krate(i,39)*exp(3.625742d0*(lnTgas(i)-1d0) &
            + 6.941559d-3*Tgas(i) &
            - 8.105797d-7*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,94) = krate(i,40)*exp(5.597728d0*(lnTgas(i)-1d0) &
            - 1.118526d-3*Tgas(i) &
            + 6.816712d-6*Tgas2(i) &
            - 3.990816d-9*Tgas3(i) &
      ...
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,94) = krate(i,40)*exp(3.920635d0*(lnTgas(i)-1d0) &
            + 7.508924d-3*Tgas(i) &
            - 8.588814d-7*Tgas2(i) &
    ...
    do i=1,cellsNumber
    !  if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
    !    krate(i,95) = krate(i,41)*exp(3.171767d-1*(lnTgas(i)-1d0) &
    !        - 2.342044d-3*Tgas(i) &
    !        - 6.420484d-7*Tgas2(i) &
    ...
    !        - 8.072663d0)
    !  elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
    !    krate(i,95) = krate(i,41)*exp(-2.545704d0*(lnTgas(i)-1d0) &
    !        - 2.859464d-4*Tgas(i) &
    !        + 5.634379d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
    !  if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
    !    krate(i,96) = krate(i,42)*exp(3.782456d0*(lnTgas(i)-1d0) &
    !        - 1.498367d-3*Tgas(i) &
    !       + 1.641217d-6*Tgas2(i) &
    ...
    !  elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
    !    krate(i,96) = krate(i,42)*exp(3.660961d0*(lnTgas(i)-1d0) &
    !        + 3.281829d-4*Tgas(i) &
    !        - 2.352494d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
    !  if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
    !    krate(i,97) = krate(i,43)*exp(3.531005d0*(lnTgas(i)-1d0) &
    !        - 6.183049d-5*Tgas(i) &
    !        - 8.383324d-8*Tgas2(i) &
    !        + 2.029422d-10*Tgas3(i) &
    !        - 7.044062d-14*Tgas4(i) &
    ...
    !  elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
    !    krate(i,97) = krate(i,43)*exp(2.952576d0*(lnTgas(i)-1d0) &
    !        + 6.984502d-4*Tgas(i) &
    !        - 8.210527d-8*Tgas2(i) &
    ...
    do i=1,cellsNumber
    !  if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
    !    krate(i,98) = krate(i,44)*exp(-1.451291d0*(lnTgas(i)-1d0) &
    !        + 7.972313d-3*Tgas(i) &
    !        - 6.985411d-6*Tgas2(i) &
    !        + 3.721109d-9*Tgas3(i) &
    ...
    !        + 3.123155d0)
    !  elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
    !    krate(i,98) = krate(i,44)*exp(4.561796d-1*(lnTgas(i)-1d0) &
    !        - 3.051946d-5*Tgas(i) &
    !        + 9.916702d-9*Tgas2(i) &
    ...
    do i=1,cellsNumber
      if(Tgas(i)<1d3.and.Tgas(i).ge.2d2) then
        krate(i,99) = krate(i,45)*exp(1.097821d-1*(lnTgas(i)-1d0) &
            - 3.673751d-4*Tgas(i) &
            + 5.268929d-7*Tgas2(i) &
            - 3.77365d-10*Tgas3(i) &
            ...
            - 5.767928d-1)
      elseif(Tgas(i).ge.1d3.and.Tgas(i).le.6d3) then
        krate(i,99) = krate(i,45)*exp(-4.721737d-1*(lnTgas(i)-1d0) &
            + 4.977041d-4*Tgas(i) &
            - 8.745815d-8*Tgas2(i) &
